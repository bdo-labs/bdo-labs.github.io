...
var _bdo_labs$bdo_labs$Author$mats = {
	firstname: 'Mats',
	lastname: 'Braa',
	email: 'mab1@bdo.no',
	bio: _elm_lang$core$Maybe$Just('Fullstack developer with interest in mobile development'),
	twitter: _elm_lang$core$Maybe$Nothing,
	github: _elm_lang$core$Maybe$Just('matsbraa')
};
var _bdo_labs$bdo_labs$Author$andreas = {firstname: 'Andreas', lastname: 'Rein', email: 'andreas.rein@bdo.no', bio: _elm_lang$core$Maybe$Nothing, twitter: _elm_lang$core$Maybe$Nothing, github: _elm_lang$core$Maybe$Nothing};
var _bdo_labs$bdo_labs$Author$henrik = {
	firstname: 'Henrik',
	lastname: 'Kjerringvåg',
	email: 'hkjels@me.com',
	bio: _elm_lang$core$Maybe$Just('Design-Oriented Functional Programmer & Pentester'),
	twitter: _elm_lang$core$Maybe$Just('hkjels'),
	github: _elm_lang$core$Maybe$Just('hkjels')
};
var _bdo_labs$bdo_labs$Author$foo = {firstname: 'foo', lastname: 'bar', email: 'report@labs.bdo.no', bio: _elm_lang$core$Maybe$Nothing, twitter: _elm_lang$core$Maybe$Nothing, github: _elm_lang$core$Maybe$Nothing};
var _bdo_labs$bdo_labs$Author$Author = F6(
	function (a, b, c, d, e, f) {
		return {firstname: a, lastname: b, email: c, bio: d, twitter: e, github: f};
	});
...
var _bdo_labs$bdo_labs$Post_WeChooseClojure$intro = A2(
...
var _bdo_labs$bdo_labs$Post_WeChooseClojure$ns = 'weChooseClojureScript';
var _bdo_labs$bdo_labs$Post_WeChooseClojure$content = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class(_bdo_labs$bdo_labs$Post_WeChooseClojure$ns),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: _bdo_labs$bdo_labs$Post_WeChooseClojure$intro,
		_1: {ctor: '[]'}
	});
var _bdo_labs$bdo_labs$Post_WeChooseClojure$post = {title: 'We Choose ClojureScript', content: _bdo_labs$bdo_labs$Post_WeChooseClojure$content, draft: false, date: 'Januar 17, 2017', author: _bdo_labs$bdo_labs$Author$henrik};

var _bdo_labs$bdo_labs$Post_GitWorkflow$intro = A2(
	_evancz$elm_markdown$Markdown$toHtml,
	{ctor: '[]'},
...
var _bdo_labs$bdo_labs$Post_GitWorkflow$ns = 'GitWorkflow';
var _bdo_labs$bdo_labs$Post_GitWorkflow$content = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class(_bdo_labs$bdo_labs$Post_GitWorkflow$ns),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: _bdo_labs$bdo_labs$Post_GitWorkflow$intro,
		_1: {ctor: '[]'}
	});
var _bdo_labs$bdo_labs$Post_GitWorkflow$post = {title: 'Git workflow', content: _bdo_labs$bdo_labs$Post_GitWorkflow$content, draft: false, date: 'March 17, 2017', author: _bdo_labs$bdo_labs$Author$mats};
...
var _bdo_labs$bdo_labs$Posts$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NextPost':
				var _p1 = _wernerdegroot$listzipper$List_Zipper$next(model.posts);
				if (_p1.ctor === 'Just') {
					return _elm_lang$core$Native_Utils.update(
						model,
						{posts: _p1._0});
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							posts: _wernerdegroot$listzipper$List_Zipper$first(model.posts)
						});
				}
			case 'PreviousPost':
				var _p2 = _wernerdegroot$listzipper$List_Zipper$previous(model.posts);
				if (_p2.ctor === 'Just') {
					return _elm_lang$core$Native_Utils.update(
						model,
						{posts: _p2._0});
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							posts: _wernerdegroot$listzipper$List_Zipper$last(model.posts)
						});
				}
			case 'GotoPost':
				var _p3 = A2(
					_wernerdegroot$listzipper$List_Zipper$find,
					function (p) {
						return _elm_lang$core$Native_Utils.eq(p, _p0._0);
					},
					_wernerdegroot$listzipper$List_Zipper$first(model.posts));
				if (_p3.ctor === 'Just') {
					return _elm_lang$core$Native_Utils.update(
						model,
						{posts: _p3._0});
...
var _bdo_labs$bdo_labs$Posts$notFound = {
	title: 'Not Found',
	content: A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('The post you are looking for is not here'),
			_1: {ctor: '[]'}
		}),
	draft: false,
	date: 'November 25, 2016',
	author: _bdo_labs$bdo_labs$Author$foo
};
var _bdo_labs$bdo_labs$Posts$model = {
	posts: A2(
		_wernerdegroot$listzipper$List_Zipper$withDefault,
		_bdo_labs$bdo_labs$Posts$notFound,
		_wernerdegroot$listzipper$List_Zipper$fromList(
			{
				ctor: '::',
				_0: _bdo_labs$bdo_labs$Post_WeChooseClojure$post,
				_1: {
					ctor: '::',
					_0: _bdo_labs$bdo_labs$Post_GitWorkflow$post,
					_1: {ctor: '[]'}
				}
			})),
	light: true
};
var _bdo_labs$bdo_labs$Posts$Model = F2(
	function (a, b) {
		return {posts: a, light: b};
	});
var _bdo_labs$bdo_labs$Posts$Post = F5(
	function (a, b, c, d, e) {
		return {title: a, content: b, draft: c, date: d, author: e};
	});
var _bdo_labs$bdo_labs$Posts$ToggleLight = {ctor: 'ToggleLight'};
var _bdo_labs$bdo_labs$Posts$GotoPost = function (a) {
	return {ctor: 'GotoPost', _0: a};
};
var _bdo_labs$bdo_labs$Posts$PreviousPost = {ctor: 'PreviousPost'};
var _bdo_labs$bdo_labs$Posts$NextPost = {ctor: 'NextPost'};
...
var _bdo_labs$bdo_labs$Stylesheets$files = _elm_lang$core$Native_Platform.outgoingPort(
	'files',
	function (v) {
...
var _bdo_labs$bdo_labs$Stylesheets$Logo = {ctor: 'Logo'};
var _bdo_labs$bdo_labs$Stylesheets$Flex = {ctor: 'Flex'};
var _bdo_labs$bdo_labs$Stylesheets$Biography = {ctor: 'Biography'};
var _bdo_labs$bdo_labs$Stylesheets$Published = {ctor: 'Published'};
var _bdo_labs$bdo_labs$Stylesheets$Wrapper = {ctor: 'Wrapper'};
var _bdo_labs$bdo_labs$Stylesheets$Spread = {ctor: 'Spread'};
var _bdo_labs$bdo_labs$Stylesheets$Dark = {ctor: 'Dark'};
var _bdo_labs$bdo_labs$Stylesheets$Light = {ctor: 'Light'};
var _bdo_labs$bdo_labs$Stylesheets$LightSwitch = {ctor: 'LightSwitch'};
var _bdo_labs$bdo_labs$Stylesheets$Social = {ctor: 'Social'};
var _bdo_labs$bdo_labs$Stylesheets$Author = {ctor: 'Author'};
var _bdo_labs$bdo_labs$Stylesheets$Photo = {ctor: 'Photo'};
var _bdo_labs$bdo_labs$Stylesheets$Row = {ctor: 'Row'};
var _bdo_labs$bdo_labs$Stylesheets$Column = {ctor: 'Column'};
var _bdo_labs$bdo_labs$Stylesheets$TimelineItem = {ctor: 'TimelineItem'};
var _bdo_labs$bdo_labs$Stylesheets$Timeline = {ctor: 'Timeline'};
var _bdo_labs$bdo_labs$Stylesheets$Container = {ctor: 'Container'};
var _bdo_labs$bdo_labs$Stylesheets$shared = _rtfeldman$elm_css$Css$stylesheet(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$each,
			{
				ctor: '::',
				...
				_0: _rtfeldman$elm_css$Css_Elements$a(
					{
						...
						_0: _rtfeldman$elm_css$Css$color(
							A3(_rtfeldman$elm_css$Css$rgb, 130, 130, 130)),
						_1: {
							ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							_bdo_labs$bdo_labs$Stylesheets$Wrapper,
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$height(
									_rtfeldman$elm_css$Css$pct(100)),
						...
						_1: {
							...
							_0: A2(
								...
								_bdo_labs$bdo_labs$Stylesheets$Logo,
								{
									ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									_bdo_labs$bdo_labs$Stylesheets$Flex,
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										_bdo_labs$bdo_labs$Stylesheets$Light,
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$backgroundColor(
												A3(_rtfeldman$elm_css$Css$rgb, 245, 245, 245)),
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$color(
															...
															_0: _rtfeldman$elm_css$Css_Elements$pre(
																{
																	ctor: '::',
																	_0: _rtfeldman$elm_css$Css$backgroundColor(
																		A3(_rtfeldman$elm_css$Css$rgb, 47, 30, 46)),
																	_1: {
																		ctor: '::',
																		_0: _rtfeldman$elm_css$Css$color(
																			A3(_rtfeldman$elm_css$Css$rgb, 163, 158, 155)),
																		_1: {ctor: '[]'}
																	}
																}),
															_1: {ctor: '[]'}
									...
									_1: {
										...
										_0: A2(
											...
											_bdo_labs$bdo_labs$Stylesheets$Biography,
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$fontSize(
										...
										_1: {
											...
											_0: A2(
												...
												_bdo_labs$bdo_labs$Stylesheets$Dark,
												{
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$backgroundColor(
														A3(_rtfeldman$elm_css$Css$rgb, 27, 35, 44)),
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$color(
															A3(_rtfeldman$elm_css$Css$rgb, 235, 235, 225)),
														_1: {
															ctor: '::',
															_0: _rtfeldman$elm_css$Css$descendants(
																{
																	...
																	_0: _rtfeldman$elm_css$Css_Elements$pre(
																		{
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$backgroundColor(
																				A3(_rtfeldman$elm_css$Css$rgb, 231, 233, 219)),
																			_1: {
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$color(
																					A3(_rtfeldman$elm_css$Css$rgb, 79, 66, 76)),
																				_1: {ctor: '[]'}
																			}
																		}),
																	_1: {
																		...
																		_0: A2(
																			...
																			_bdo_labs$bdo_labs$Stylesheets$LightSwitch,
																			{
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$color(
																		...
																		_1: {
																			...
																			_0: A2(
																				...
																				_bdo_labs$bdo_labs$Stylesheets$Social,
																				{
																					ctor: '::',
																					_0: _rtfeldman$elm_css$Css$backgroundColor(
																						A3(_rtfeldman$elm_css$Css$rgb, 20, 20, 20)),
																					_1: {ctor: '[]'}
																				}),
																			_1: {
																				ctor: '::',
																						...
																						_0: _rtfeldman$elm_css$Css$hover(
																							{
																								ctor: '::',
																								_0: _rtfeldman$elm_css$Css$color(
																									A3(_rtfeldman$elm_css$Css$rgb, 250, 250, 250)),
																								_1: {ctor: '[]'}
																							}),
																						_1: {ctor: '[]'}
																					}),
												...
												_1: {
													...
													_0: A2(
														_rtfeldman$elm_css$Css$each,
														{
															...
															_1: {
																ctor: '::',
																_0: _rtfeldman$elm_css$Css_Elements$h3,
																_1: {
																	ctor: '::',
																	_0: _rtfeldman$elm_css$Css_Elements$h4,
																	_1: {
																		ctor: '::',
																		_0: _rtfeldman$elm_css$Css_Elements$h5,
																		_1: {ctor: '[]'}
																	}
																}
															}
															...
															_1: {
																														...
																														_1: {
																															...
																															_1: {
																																...
																																_1: {
																																	ctor: '::',
																																	_0: _rtfeldman$elm_css$Css$backgroundColor(
																																		A3(_rtfeldman$elm_css$Css$rgb, 255, 255, 220)),
																																	_1: {
																																		ctor: '::',
																																		_0: A5(
																...
																_1: {
																	...
																	_0: A2(
																		...
																		_bdo_labs$bdo_labs$Stylesheets$Photo,
																		{
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$borderRadius(
																	...
																	_1: {
																		...
																		_0: A2(
																			...
																			_bdo_labs$bdo_labs$Stylesheets$Author,
																			{
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$marginTop(
																						...
																						_0: _rtfeldman$elm_css$Css$children(
																							{
																								...
																								_1: {
																									ctor: '::',
																									_0: _rtfeldman$elm_css$Css_Elements$small(
																										{
																											ctor: '::',
																											_0: _rtfeldman$elm_css$Css$marginLeft(
																												_rtfeldman$elm_css$Css$em(1)),
																		...
																		_1: {
																			...
																			_0: A2(
																				...
																				_bdo_labs$bdo_labs$Stylesheets$Published,
																				{
																					ctor: '::',
																					_0: _rtfeldman$elm_css$Css$fontSize(
																						_rtfeldman$elm_css$Css$em(0.6)),
																					_1: {
																						...
																						_1: {
																							ctor: '::',
																							_0: _rtfeldman$elm_css$Css$color(
																								A3(_rtfeldman$elm_css$Css$rgb, 145, 145, 145)),
																							_1: {ctor: '[]'}
																						}
																					}
																				}),
																			_1: {
																							...
																							_1: {
																								...
																								_1: {
																									...
																									_1: {
																										ctor: '::',
																										_0: _rtfeldman$elm_css$Css$transform(
																											_rtfeldman$elm_css$Css$scale(0.75)),
																										_1: {
																											ctor: '::',
																											_0: _rtfeldman$elm_css$Css$children(
																												{
																				...
																				_1: {
																					...
																					_0: A2(
																						...
																						_bdo_labs$bdo_labs$Stylesheets$Column,
																						{
																							ctor: '::',
																					...
																					_1: {
																						...
																						_0: A2(
																							...
																							_bdo_labs$bdo_labs$Stylesheets$Row,
																							{
																								ctor: '::',
																								_0: _rtfeldman$elm_css$Css$displayFlex,
																								_1: {
																						...
																						_1: {
																							...
																							_0: A2(
																								...
																								_bdo_labs$bdo_labs$Stylesheets$Container,
																								{
																									ctor: '::',
																							...
																							_1: {
																								...
																								_0: A2(
																									...
																									_bdo_labs$bdo_labs$Stylesheets$Timeline,
																									{
																										ctor: '::',
																															...
																															_0: _rtfeldman$elm_css$Css$children(
																																{
																																	...
																																	_0: A2(
																																		...
																																		_bdo_labs$bdo_labs$Stylesheets$TimelineItem,
																																		{
																																			ctor: '::',
																																			_0: _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$block),
																																			_1: {
																																...
																																_0: A2(
																																	...
																																	_bdo_labs$bdo_labs$Stylesheets$Timeline,
																																	{
																																		...
																																		_0: A3(
																																			...
																																			A3(_rtfeldman$elm_css$Css$rgb, 50, 50, 50)),
																																		_1: {ctor: '[]'}
																																	}),
																																_1: {
																																	ctor: '::',
																																								...
																																								_0: _rtfeldman$elm_css$Css$hover(
																																									{
																																										ctor: '::',
																																										_0: _rtfeldman$elm_css$Css$transform(
																																											_rtfeldman$elm_css$Css$scale(1.8)),
																																										_1: {
																																											ctor: '::',
																																											_0: _rtfeldman$elm_css$Css$before(
																																												{
																																											...
																																											_1: {
																																												ctor: '::',
																																												_0: _rtfeldman$elm_css$Css$adjacentSiblings(
																																													{
																																														ctor: '::',
																																														_0: A2(
																																															F2(
																																															...
																																															_bdo_labs$bdo_labs$Stylesheets$TimelineItem,
																																															{
																																																ctor: '::',
																																																_0: _rtfeldman$elm_css$Css$transform(
																																																	_rtfeldman$elm_css$Css$scale(1.4)),
																																																_1: {ctor: '[]'}
																																															}),
																																														_1: {ctor: '[]'}
																																													}),
...
var _bdo_labs$bdo_labs$Stylesheets$cssFiles = _rtfeldman$elm_css$Css_File$toFileStructure(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			...
			_1: _rtfeldman$elm_css$Css_File$compile(
				{
					ctor: '::',
					_0: _bdo_labs$bdo_labs$Stylesheets$shared,
					_1: {ctor: '[]'}
				})
		},
		_1: {ctor: '[]'}
	});
var _bdo_labs$bdo_labs$Stylesheets$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: {ctor: '_Tuple0'},
			_1: _bdo_labs$bdo_labs$Stylesheets$files(_bdo_labs$bdo_labs$Stylesheets$cssFiles)
		},
		update: F2(
			function (_p1, _p0) {
				return {
...
var _bdo_labs$bdo_labs$Main$stylesheet = function (scheme) {
	var children = {ctor: '[]'};
	var attrs = {
		ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						'./styles/paraiso-',
						A2(_elm_lang$core$Basics_ops['++'], scheme, '.css'))),
				_1: {ctor: '[]'}
			}
		}
	};
...
var _bdo_labs$bdo_labs$Main$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('');
var _bdo_labs$bdo_labs$Main$id = _bdo_labs$bdo_labs$Main$_p0.id;
var _bdo_labs$bdo_labs$Main$class = _bdo_labs$bdo_labs$Main$_p0.$class;
var _bdo_labs$bdo_labs$Main$classList = _bdo_labs$bdo_labs$Main$_p0.classList;
var _bdo_labs$bdo_labs$Main$postItem = function (post) {
	return (!post.draft) ? A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_bdo_labs$bdo_labs$Posts$GotoPost(post)),
			_1: {
				ctor: '::',
				_0: _bdo_labs$bdo_labs$Main$class(
					{
						ctor: '::',
						_0: _bdo_labs$bdo_labs$Stylesheets$TimelineItem,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _bdo_labs$bdo_labs$Main$photo = function (props) {
	var _p1 = props;
	var email = _p1.email;
	var size = _p1.size;
	var hash = _sanichi$elm_md5$MD5$hex(
		_elm_lang$core$String$toLower(
			_elm_lang$core$String$trim(email)));
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
			...
			_0: A2(
				_elm_lang$html$Html$img,
				{
					...
					_0: _bdo_labs$bdo_labs$Main$class(
						{
							ctor: '::',
							_0: _bdo_labs$bdo_labs$Stylesheets$Photo,
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _bdo_labs$bdo_labs$Main$footer = A2(
	_elm_lang$html$Html$footer,
	{
		...
		_0: _bdo_labs$bdo_labs$Main$class(
			{
				ctor: '::',
				_0: _bdo_labs$bdo_labs$Stylesheets$Row,
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	},
	{
		...
		_0: A2(
			_elm_lang$html$Html$span,
			{
				...
				_0: _bdo_labs$bdo_labs$Main$class(
					{
						ctor: '::',
						_0: _bdo_labs$bdo_labs$Stylesheets$Flex,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href('https://github.com/bdo-labs/'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('ion-social-github'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'font-size', _1: '1.8rem'},
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _bdo_labs$bdo_labs$Main$view = function (model) {
	var scheme = model.light ? 'light' : 'dark';
	var post = _wernerdegroot$listzipper$List_Zipper$current(model.posts);
	var author = post.author;
	var fullname = A2(
		_elm_lang$core$Basics_ops['++'],
		author.firstname,
		A2(_elm_lang$core$Basics_ops['++'], ' ', author.lastname));
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _bdo_labs$bdo_labs$Main$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'Light', _1: model.light},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'Dark', _1: !model.light},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'Wrapper', _1: true},
							_1: {ctor: '[]'}
						}
					}
				}),
		...
		{
			ctor: '::',
			_0: _bdo_labs$bdo_labs$Main$stylesheet(scheme),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$menu,
					{
						ctor: '::',
						_0: _bdo_labs$bdo_labs$Main$class(
							{
								ctor: '::',
								_0: _bdo_labs$bdo_labs$Stylesheets$Timeline,
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
					A2(
						_elm_lang$core$List$map,
						_bdo_labs$bdo_labs$Main$postItem,
						_wernerdegroot$listzipper$List_Zipper$toList(model.posts))),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _bdo_labs$bdo_labs$Main$class(
								{
									ctor: '::',
									_0: _bdo_labs$bdo_labs$Stylesheets$Container,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_0: _bdo_labs$bdo_labs$Main$class(
										{
											ctor: '::',
											_0: _bdo_labs$bdo_labs$Stylesheets$LightSwitch,
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_bdo_labs$bdo_labs$Posts$ToggleLight),
										_1: {ctor: '[]'}
									}
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$span,
										{
											...
											_0: _bdo_labs$bdo_labs$Main$classList(
												{
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'ion-ios-lightbulb', _1: model.light},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'ion-ios-lightbulb-outline', _1: !model.light},
														_1: {ctor: '[]'}
													}
												}),
											_1: {ctor: '[]'}
									...
									_0: A2(
										_elm_lang$html$Html$div,
										{
											...
											_0: _bdo_labs$bdo_labs$Main$class(
												{
													ctor: '::',
													_0: _bdo_labs$bdo_labs$Stylesheets$Author,
													_1: {
														ctor: '::',
														_0: _bdo_labs$bdo_labs$Stylesheets$Row,
														_1: {ctor: '[]'}
										...
										{
											ctor: '::',
											_0: _bdo_labs$bdo_labs$Main$photo(
												{email: author.email, size: 200}),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$div,
													{
														...
														_0: _bdo_labs$bdo_labs$Main$class(
															{
																ctor: '::',
																_0: _bdo_labs$bdo_labs$Stylesheets$Column,
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													},
																	...
																	_0: A2(
																		_elm_lang$html$Html$span,
																		{
																			...
																			_0: _bdo_labs$bdo_labs$Main$class(
																				{
																					ctor: '::',
																					_0: _bdo_labs$bdo_labs$Stylesheets$Published,
																					_1: {ctor: '[]'}
																				}),
																			_1: {ctor: '[]'}
																		},
																	...
																	return A2(
																		_elm_lang$html$Html$small,
																		{
																			...
																			_0: _bdo_labs$bdo_labs$Main$class(
																				{
																					ctor: '::',
																					_0: _bdo_labs$bdo_labs$Stylesheets$Biography,
																					_1: {ctor: '[]'}
																				}),
																			_1: {ctor: '[]'}
																		},
																...
																_0: A2(
																	_elm_lang$html$Html$div,
																	{
																		...
																		_0: _bdo_labs$bdo_labs$Main$class(
																			{
																				ctor: '::',
																				_0: _bdo_labs$bdo_labs$Stylesheets$Social,
																				_1: {ctor: '[]'}
																			}),
																		_1: {ctor: '[]'}
																	},
																	{
																		ctor: '::',
																		_0: function () {
																			var _p3 = author.github;
																			if (_p3.ctor === 'Just') {
																				var url = A2(_elm_lang$core$Basics_ops['++'], 'https://github.com/', _p3._0);
																				return A2(
																					_elm_lang$html$Html$a,
																					{
																						ctor: '::',
																		...
																		_1: {
																			ctor: '::',
																			_0: function () {
																				var _p4 = author.twitter;
																				if (_p4.ctor === 'Just') {
																					var url = A2(_elm_lang$core$Basics_ops['++'], 'https://twitter.com/', _p4._0);
																					return A2(
																						_elm_lang$html$Html$a,
																						{
																							ctor: '::',
																							...
																							_1: {
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$class('ion-social-twitter'),
																								_1: {ctor: '[]'}
																							}
																						},
																						{ctor: '[]'});
					...
					_1: {
						ctor: '::',
						_0: _bdo_labs$bdo_labs$Main$footer,
						_1: {ctor: '[]'}
					}
				}
			}
...
var _bdo_labs$bdo_labs$Main$main = _elm_lang$html$Html$beginnerProgram(
	{model: _bdo_labs$bdo_labs$Posts$model, view: _bdo_labs$bdo_labs$Main$view, update: _bdo_labs$bdo_labs$Posts$update})();
var _bdo_labs$bdo_labs$Main$PhotoModel = F2(
	function (a, b) {
		return {email: a, size: b};
	});

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _bdo_labs$bdo_labs$Main$main !== 'undefined') {
    _bdo_labs$bdo_labs$Main$main(Elm['Main'], 'Main', undefined);
}
